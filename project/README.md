...
На защите я покажу структуру своего проекта, расскажу о задаче, покажу основные выводы по данным и сравнению моделей машинного обучения (по ноутбукам). Затем запущу сервис, покажу его работоспособность, продемонтрирую несколько запросов и результат работы сервиса.
